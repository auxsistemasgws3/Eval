...
class EvaluacionesController extends Controller
{
    ...
    {   
        ...
        */
        ...
        $departamentos_lst = EvaluacionesDepartamento::where('active', 3)->whereIn('name', $resultado)->whereIn('id_dictionaries', $idRelaciones)->with('lider')->orderBy('code', 'ASC')->get();
        ...
        $usuariosEvaluar = User::selectraw("id AS value, id, CONCAT(name, ' ', primer_apellido , ' ', segundo_apellido) label, id_departamento, sucursal_id, puesto")->whereIn('id', $Evaluadosarray)->where('jefe_inmediato', $user->id)->orderBy('created_at', 'ASC')->get();
    ...
    {
        $questions = Dictionary::select('code as value', 'text as label')->where('reference_type', 'LIDER')->where('active',5 )->orderBy('sort', 'ASC')->get();
