    ...
    <main>
        ...
        <div>
            ...
            <p class="justify">Contrato de arrendamiento con opción a compra que celebran por una parte <strong>GWS GRUPO WATT SOLAR SA DE CV</strong> , con RFC: <strong>GGW191209MZA</strong>
                ...
                se le denomina como <strong>“EL ARRENDADOR”</strong> y por la otra parte {{$orden->nombre_cliente}} de nacionalidad mexicana con
                Identificación Oficial No. IFE {{$orden->ine_ife}}, {{$orden->calle_ine_ife}} {{$orden->colonia_ine_ife}} {{$orden->numero_ine_ife}}, {{$orden->localidad_ine_ife}} , {{$orden['EstadoINE']->nombre}}, C.P {{$orden->cp_ine_ife}} . Quien en lo sucesivo se le denominará
        ...
        <div>
            ...
            <br>a) Qué está legalmente facultado para dar en arrendamiento el “Proyecto Solar” en los términos y condiciones establecidos en este contrato.
            ...
            <br>b) Que es su deseo tomar en arrendamiento el “Proyecto Solar”, de conformidad con los términos del presente contrato.
            ...
            Tercera. - Declaran ambas partes Que, en la celebración del presente Contrato, no ha mediado entre ellas error, dolo, violencia o mala fe de ninguna índole.
            <br>a) Que, en virtud de lo anterior, se obligan de conformidad con las siguientes:
            ...
            <p><strong>4.1.- “El ARRENDATARIO”</strong> se obliga a pagar a <strong>“EL ARRENDADOR”</strong> por el cumplimiento total de sus obligaciones, la cantidad total de <strong>${{$orden->valor_contrato}} MN (Son {{$ContratoTotalLetra}})</strong>. que en lo sucesivo se le denominará “Valor Total del Contrato”.</p>
            ...
            <p><strong>4.2.-</strong> Con la celebración del presente contrato “El Arrendatario” se obliga a pagar a <strong>“EL ARRENDADOR”</strong> la cantidad exacta de <strong>${{$orden->anticipo}} MN (Son {{$AnticipoLetra}})</strong> en la cuenta señalada, en la cláusula, 4.10, del presente contrato, a más tardar un día hábil después de la firma del presente contrato.</p>
            ...
            <p><strong>4.9.- Si “EL ARRENDATARIO”</strong> es omiso en pagar la renta con opción a compra en la fecha límite que corresponde, entonces deberá cubrir una penalidad correspondiente al interés del _5__% sobre el monto que está omitiendo cubrir, <strong>aplicable a partir del 3er día hábil</strong> después de la fecha límite de pago el cual será acumulable.</p>
            ...
            <p><strong>6.1.-</strong> Para la terminación del contrato será suficiente la notificación vía celular a “EL ARRENDATARIO” al celular <strong>{{$orden->telefono}} y Correo {{$orden->correo}}</strong></p>
            <p><strong>6.1.1.-</strong> Una vez notificado por correo o vía celular a <strong>“EL ARRENDATARIO”</strong> la terminación del presente por impago el mismo acepta otorgar pleno acceso al domicilio donde se encuentre instalado <strong>LOS PANELES SOLARES INVERSOR Y ESTRUCTURA</strong>, a efecto de que se desinstale y recupere, para ello, autoriza el acceso a El Domicilio aún y cuando no se encuentre presente su propietario y/o arrendatario.</p>
            <p><strong>6.1.2.- “EL ARRENDATARIO”</strong> renuncia al derecho de reclamar daños colaterales con motivos de los orificios de taquetes de expansión, daños a la pintura y/o impermeabilizado, que hayan acontecido con motivo de la instalación y/o desinstalación y/o retiro de los paneles, inversor y estructura.</p>
            <p><strong>6.2.- “El ARRENDATARIO”</strong> acepta que en caso de recisión de contrato tendrá una penalización del 20% del total de la venta, los cuales se restarán del enganche y pagos mensuales cubiertos y no así la devolución de los intereses, en el entendido que la diferencia se le devolverá a <strong>“EL ARRENDATARIO”</strong> siempre y cuando el equipo este en las condiciones normales de uso por clima. </p>
            ...
            <p><strong>12.-</strong> La duración del presente contrato tendrá una vigencia de No. meses a partir de la fecha de la primer mensualidad.</p>
            ...
            <p>El presente contrato es impreso en dos tantos y firmado en fecha {{$vars_fecha[0]}} en la ciudad de Ciudad y Estado.</p>
        </div>
        <table id="firmas">
            <tbody>
                <tr>
