    ...
    <header>
        <table id="encabezado">
            <tr>
                ...
                <td width="45%" style="text-align: right;">Contrato CNTD No. {{$orden->no_contrato}}</td>
            </tr>
        </table>
    </header>
    ...
    <main>
        ...
        <div>
            ...
            <p><strong>CONTRATO DE CONSTRUCCIÓN DE OBRA que celebran por una parte GWS GRUPO WATT SOLAR SA DE CV,</strong> con RFC: GGW191209MZA
                ...
                sucesivo se le denomina como <strong>“EL CONTRATISTA”</strong> por la otra parte el {{$orden->nombre_cliente}} {{$TipoPersona_Pa_1}} de nacionalidad mexicana con Identificación Oficial {{$orden->ine_ife}}
                , con domicilio en {{$orden->calle_ine_ife}} {{$orden->colonia_ine_ife}} {{$orden->numero_ine_ife}}, {{$orden->localidad_ine_ife}} , {{$orden['EstadoINE']->nombre}}, C.P {{$orden->cp_ine_ife}}, a quien en lo sucesivo se le denominara <strong>“EL CLIENTE”</strong>, los cuales se sujetan de común acuerdo al tenor
        ...
        <br>
        <p class="titulos1"><span>CLAUSULAS</span></p>
        ...
        <p>2.1. El Contratista será responsable de que el Proyecto y cualesquier cambios de la Obra y la ejecución de sus servicios, cumplan con las leyes y reglamentos municipales, estatales y federales aplicables al diseño y construcción del Proyecto,
            ...
            (“<span>Requisitos Legales</span>”). <span>Sin costo adicional para el "Cliente"</span>. El Cliente estaría obligado a aceptar los cambios necesarios que se hicieran en cuanto a diseño y fechas de entrega cuando sea necesario para cumplir con los Requisitos Legales. </p>
        ...
        <p>3.4. <span>Pruebas</span>. El Contratista proporcionará toda la mano de obra, materiales y equipo requeridos para realizar todas las pruebas de desempeño y demás pruebas que resulten aplicables
        ...
        <p>4.2. <span>Valor Total del Contrato.</span> El “Cliente” se obliga a pagar al Contratista por el cumplimiento total de sus obligaciones, la cantidad total de $<?php echo number_format($orden->valor_contrato, 2); ?>
            en lo sucesivo se le denominará <span>“Valor Total del Contrato”</span>, {{$var_importes[0]}}. El Valor Total del Contrato comprende el Anticipo referido en la cláusula siguiente, así como
            el costo por instalación de cada uno de los paneles solares que comprende el proyecto, conforme al Anexo 1. </p>

        <p>4.3 Con la celebración de este contrato el Cliente se obliga a pagar al contratista el 50% por la cantidad equivalente a $<?php echo number_format($var_importes[2], 2); ?> MN (Son {{$var_importes[3]}})
        ...
        <p>4.8. Si El Cliente es omiso en pagar el resto del valor total de la obra, en la fecha lí­mite que corresponde, entonces deberá cubrir una penalidad correspondiente al interés moratorio del 5% sobre el monto vencido,
            aplicable a partir del 2do. (Segundo), día hábil después de la fecha de entrega de la obra terminada. </p>

        <p class="Sangria1">4.8.1 ante la negativa de EL <strong>CLIENTE</strong> a cubrir los pagos mencionados en la cláusula 4.7 a partir del 7mo.(séptimo) día hábil, se determinara automáticamente La terminación inmediata del presente contrato por
        ...
        <p class="titulos2">DESCRIPCIÓN DEL PROYECTO. </p>
        ...
        <p class="Sangria1">4.8.2 Para la terminación del contrato será suficiente la notificación vía correo electrónico y/o mensaje de texto enviada a <strong>“EL CLIENTE” </strong> al correo: {{$orden->correo}} y al celular {{$orden->telefono}} </p>
        <p class="Sangria1">4.8.3 Una vez notificado por correo y/o mensaje de texto a “EL CLIENTE” la terminación del presente por impago el mismo acepta otorgar pleno acceso al domicilio donde se encuentre instalado LOS PANELES SOLARES
            <strong>INVERSOR Y ESTRUCTURA,</strong> a efecto de que se desinstale y recupere, para ello, autoriza el acceso a El Domicilio aún y cuando no se encuentre presente su propietario.
        </p>
        <p class="Sangria1">4.8.4 <strong> “EL CLIENTE”</strong> renuncia al derecho de reclamar daños colaterales con motivos de los orificios de taquetes de expansión, daños a la pintura y/o impermeabilizado, que hayan acontecido con motivo de la instalación y/o desinstalación y/o retiro de los paneles, inversor y estructura. </p>
        ...
        <p>5.1. <span>Facturación.</span> Al recibir cualquier pago del “Cliente” incluyendo cualquier liberación de Retención, el Contratista se obliga a entregar posteriormente una factura que cumpla con todos los requisitos legales, contenga desglose del impuesto al valor agregado y la cantidad en Pesos, moneda nacional,
        ...
        <p>El presente Contrato, fue leí­do, estando los contratantes enterados de su contenido, alcance y fuerza legal, lo ratifican en todas sus partes y lo firman para constancia, el "Cliente" y El "Contratista".</p>
        ...
        <div>
            ...
            <p>Acta de <strong>ENTREGA-RECEPCIÓN</strong> de la obra de acuerdo con el contrato del “Proyecto solar” celebrado con fecha {{$vars_fecha[0]}}, en {{$orden->localidad}}, {{$orden['Estado']->nombre}}, entre <strong>GWS GRUPO WATT SOLAR SA DE CV Y {{$orden->nombre_cliente}}</strong>.</p>
        </div>


        <div>
            <p class="titulos1">DECLARACIONES
            <p><strong>Primero.-</strong> <strong>“EL CLIENTE” y “EL CONTRATISTA”</strong> celebraron un Contrato del Proyecto Solar en {{$orden->localidad}}, {{$orden['Estado']->nombre}}.</p>
            ...
            <ol type="a">
                <li>En este acto, “EL CONTRATISTA” entrega a “EL CLIENTE” la Obra, la cual recibe a su entera satisfacción y en cumplimiento con las especificaciones de la Obra contenidas en este Contrato.
                <li>La entrega se realiza en el domicilio ubicado en calle {{$orden->calle}} {{$orden->colonia}} {{$orden->numero}}, {{$orden->localidad}} , {{$orden['Estado']->nombre}}, C.P {{$orden->cp}} Físicamente conforme a lo establecido en el presente contrato. C. Domicilio completo donde se hará la Instalacion. Físicamente conforme a lo establecido en el presente contrato.
                <li><span>EL CLIENTE se da por enterado que el ahorro real se verá reflejado una vez que se cumplan las siguientes condiciones:</span></li>
                <ol type="1">
