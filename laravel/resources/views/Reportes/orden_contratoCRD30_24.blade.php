...
<body>
    ...
    <main>
        ...
        <div>
            ...
            <p>Acta de <strong>ENTREGA-RECEPCIÓN</strong> de la obra de acuerdo con el contrato de <strong>ARRENDAMIENTO CON OPCIÓN A COMPRA</strong> del “Proyecto solar” celebrado con fecha , en chihuahua, Chih., entre <strong>GWS GRUPO WATT SOLAR SA DE CV Y {{$orden->nombre_cliente}}</strong>.</p>
        </div>
        ...
        <div>
            ...
            <table style="width:100%">
                ...
                <tr>
                    <td width="100%">
                        <img src="{{$file->getPath()}}" alt="CORRIDA_pagos" style="max-width:600px;width:100%" />
                    </td>
                </tr>
                @endif
                @endforeach
